            ...
            <div class="login-form">
                ...
                <div class="body">
                    ...
                    <div class="item space">
                        <input v-model="code" type="text" @focus="editCode()" @blur="testCode()" class="text code" maxlength="6" placeholder="请输入验证码"/>
                    ...
                    <a class="login-btn toSib" @click="confirm">确认</a>
                </div>
            </div>
        </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    confirm() {
      ...
      adminApi.editPassword(user).then(res => {
        if (res.code == 0){
          vm.$message.success("密码修改成功，请登录");
          vm.$router.push({path:'/login'});
        }
        else vm.$message.error(res.errMsg);
      });
